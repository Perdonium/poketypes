    ...
    return (
        <>
                ...
                <defs>
                    <pattern id="pokeballPattern" patternUnits="userSpaceOnUse" width="50" height="50">
                        <g transform="scale(0.05)">
                            <g id="Pokéball_1_">
                                <g id="Colours">
                                    <path id="Down" className="st0" d="M297.6,380.9c-40.4,0-74.1-28.6-82.1-66.6H81.1c9.5,110.5,102.2,197.2,215.1,197.2
			s205.7-86.7,215.1-197.2H379.7C371.7,352.4,338,380.9,297.6,380.9z"/>
                                    <path id="Shadow_Down" className="st1"
                                          d="M345.6,505.9c89.6-21,157.7-97.7,165.7-191.6h-53C453,399.5,408.3,471.7,345.6,505.9z"/>
                                    <path id="Center" className="st0" d="M347.1,297L347.1,297C347,297,347,297,347.1,297c-0.1-6.1-1.2-11.9-3.2-17.3
			...
			C347.1,297,347.1,297,347.1,297z"/>
                                    <path id="Up" className="st2" d="M297.7,213.2c40.4,0,74.1,28.6,82.1,66.6h134.4C504.7,169.2,412,82.5,299,82.5S93.4,169.2,83.9,279.7
			h131.7C223.6,241.7,257.3,213.2,297.7,213.2z"/>
                                    <path id="Shadow_Up" className="st3"
		...
		C156.4,41.3,41.9,155.8,41.9,297s114.5,255.7,255.7,255.7S553.4,438.3,553.4,297S438.9,41.3,297.6,41.3z"/>
            ...
            <svg className={"absolute -z-10 opacity-50 w-full h-full"} xmlns="http://www.w3.org/2000/svg" version="1.1"
                ...
                <g mask="url(&quot;#SvgjsMask1018&quot;)" fill="none">
                    ...
                    <path d="M1920 0L1809.53 0L1920 479.68z" fill="rgba(255, 255, 255, .1)"></path>
                    <path d="M1809.53 0L1920 479.68L1920 609.36L1367.27 0z" fill="rgba(255, 255, 255, .075)"></path>
                    <path d="M1367.27 0L1920 609.36L1920 877.59L1027.62 0z" fill="rgba(255, 255, 255, .05)"></path>
                    <path d="M1027.62 0L1920 877.59L1920 882.33L374.19999999999993 0z"
                          fill="rgba(255, 255, 255, .025)"></path>
                    <path d="M0 1080L765.38 1080L0 1042.55z" fill="rgba(0, 0, 0, .1)"></path>
                    <path d="M0 1042.55L765.38 1080L885 1080L0 887.4699999999999z" fill="rgba(0, 0, 0, .075)"></path>
                    <path d="M0 887.47L885 1080L1331.22 1080L0 478.76000000000005z" fill="rgba(0, 0, 0, .05)"></path>
                    <path d="M0 478.76L1331.22 1080L1360.3 1080L0 248.23999999999998z"
